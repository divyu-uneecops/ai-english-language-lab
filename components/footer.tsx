...
export function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background:
          "linear-gradient(135deg, #FF6D25 0%, #FF8A50 50%, #FF6D25 100%)",
      }}
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{ backgroundColor: "rgba(255, 109, 37, 0.3)" }}
        ></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          {/* Left side: Brand + Learning Modules */}
        ...
        <div className="pt-8 border-t border-white/20 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <span className="text-white/80 text-sm">
              © {new Date().getFullYear()} English Lab
            </span>
            <button
              onClick={scrollToTop}
